...
struct Configuration {
  ...
  var cancelText: String {
    get {return _storage._cancelText}
    set {_uniqueStorage()._cancelText = newValue}
  }

  var flashOnText: String {
    get {return _storage._flashOnText}
    set {_uniqueStorage()._flashOnText = newValue}
  }

  var flashOffText: String {
    get {return _storage._flashOffText}
    set {_uniqueStorage()._flashOffText = newValue}
  }
...
extension Configuration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .same(proto: "autoEnableFlash"),
  ]

  fileprivate class _StorageClass {
    var _cancelText: String = String()
    var _flashOnText: String = String()
    var _flashOffText: String = String()
    ...
    init(copying source: _StorageClass) {
      _cancelText = source._cancelText
      _flashOnText = source._flashOnText
      _flashOffText = source._flashOffText
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularStringField(value: &_storage._cancelText)
        case 2: try decoder.decodeSingularStringField(value: &_storage._flashOnText)
        case 3: try decoder.decodeSingularStringField(value: &_storage._flashOffText)
        case 4: try decoder.decodeRepeatedEnumField(value: &_storage._restrictFormat)
        case 5: try decoder.decodeSingularInt32Field(value: &_storage._useCamera)
        case 6: try decoder.decodeSingularMessageField(value: &_storage._android)
        case 7: try decoder.decodeSingularBoolField(value: &_storage._autoEnableFlash)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._cancelText.isEmpty {
        try visitor.visitSingularStringField(value: _storage._cancelText, fieldNumber: 1)
      }
      if !_storage._flashOnText.isEmpty {
        try visitor.visitSingularStringField(value: _storage._flashOnText, fieldNumber: 2)
      }
      if !_storage._flashOffText.isEmpty {
        try visitor.visitSingularStringField(value: _storage._flashOffText, fieldNumber: 3)
      }
      if !_storage._restrictFormat.isEmpty {
        try visitor.visitPackedEnumField(value: _storage._restrictFormat, fieldNumber: 4)
      }
      if _storage._useCamera != 0 {
        try visitor.visitSingularInt32Field(value: _storage._useCamera, fieldNumber: 5)
      }
      if let v = _storage._android {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
      }
      if _storage._autoEnableFlash != false {
        try visitor.visitSingularBoolField(value: _storage._autoEnableFlash, fieldNumber: 7)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Configuration, rhs: Configuration) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._cancelText != rhs_storage._cancelText {return false}
        if _storage._flashOnText != rhs_storage._flashOnText {return false}
        if _storage._flashOffText != rhs_storage._flashOffText {return false}
